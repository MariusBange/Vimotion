...
# Dataset
class centerKeyframeDataset(data.Dataset):
    """Liris-Accede Custom Dataset """
    def __init__(self, csv_path_file, root_dir,transform=None):
        ...
        #
        self.transform_resize = transforms.Resize(size=224, interpolation=Image.BILINEAR) # output is size*H/W, size    # THAO !!!
    ...
    def __getitem__(self, index):
        ...
        # resize
        image_as_image = self.transform_resize(image_as_image)  # THAO !!!
